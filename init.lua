...
-- Simple keymap to insert a Go error handling block
-- ge = go error
vim.keymap.set("n", "<leader>ge", function()
  -- The text to insert, as a table of strings (one string per line)
  local err_snippet = {
    "if err != nil {",
    "    return err",
    "}",
  ...
  -- Insert the snippet as new lines below the cursor
  vim.api.nvim_put(err_snippet, "l", true, true)
